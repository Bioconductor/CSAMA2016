...
genes are changing their expression after treatment.

An overview of the steps we will take (and alternatives) is:

1. Preprocess FASTQ files
    + Align to the genome with STAR or other software.
    + Quantify at transcript level using Sailfish, Salmon or kallisto 
