...
reads/fragments. This is important for *DESeq2* or *edgeR*'s statistical model to
...
TODO note about F1000R paper and estimated counts

## Aligning reads to a reference genome

TODO comparing aligning reads vs running quantifiers
...
can be added to automatically sort the files and turn them into 
...
TODO kill this table and generalize text
...
This chunk of code can be run to produce a simple diagram of 
