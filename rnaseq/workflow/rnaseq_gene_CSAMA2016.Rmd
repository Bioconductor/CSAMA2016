...
with zero or very few reads. In order to streamline the
...
some temporary code written on June 17 to test we have necessary packages
...
plot(rank(res$padj[common]), rank(tt.all$table$FDR[common]), cex=.1)
```
...
# TODO turn this into a code chunk
