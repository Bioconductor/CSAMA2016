...
\begin{frame}{\R: Statistical Computing Environment}
  ...
  \item Vectors -- logical, integer, numeric, character, \ldots
    ...
    \item Can be \emph{named} -- \Rcode{c(Portugal=1, France=0)}
    \end{itemize}
  ...
  \item Other classes -- more complicated arrangement of vectors.
    ...
    \item function, `generic', and `method'
    \end{itemize}
...
\begin{frame}{\R: help!}
  \begin{itemize}
  \item \Rcode{?data.frame}, \Rcode{?"plot<tab>"}
  \item \Rcode{methods(class=class(fit))}, \Rcode{methods(anova)}
...
\begin{frame}{\Bioconductor{}}
  ...
  \begin{itemize}
  \item $15$ years old; 1211 packages; widely used
...
\begin{frame}{\Bioconductor: Resources}
  ...
  \item Huber et al. (2015) Orchestrating high-throughput genomic
    ...
    12:\href{https://doi.org/10.1038/nmeth.3252}{115-121}.
  \item Lawrence et al. (2013) Software for Computing and Annotating
    Genomic Ranges. PLoS Comput Biol 9(8):
    \href{https://doi.org/10.1371/journal.pcbi.1003118}{e1003118}.
  \end{itemize}
